...
def make_beautiful_plots(dataset, combined_metrics_dict, algo):
    """
    ...
    if algo in ["ab", "all"]:
        ...
        y = [combined_metrics_dict[test_size]["ab50_metrics_dict"]["acc"], combined_metrics_dict[test_size]["ab100_metrics_dict"]["acc"], combined_metrics_dict[test_size]["ab200_metrics_dict"]["acc"], combined_metrics_dict[test_size]["ab300_metrics_dict"]["acc"], combined_metrics_dict[test_size]["ab400_metrics_dict"]["acc"], combined_metrics_dict[test_size]["ab500_metrics_dict"]["acc"]]
    ...
    if algo in ["nn", "all"]:
        ...
        x = [50, 100, 200, 500, 750]
        y = [combined_metrics_dict[test_size]["nn50_metrics_dict"]["acc"], combined_metrics_dict[test_size]["nn100_metrics_dict"]["acc"], combined_metrics_dict[test_size]["nn200_metrics_dict"]["acc"], combined_metrics_dict[test_size]["nn500_metrics_dict"]["acc"], combined_metrics_dict[test_size]["nn750_metrics_dict"]["acc"]]
    ...
    if algo in ["svm", "all"]:
        ...
        x = [50, 100, 200, 500, 750]
        y = [combined_metrics_dict[test_size]["svm50_metrics_dict"]["acc"], combined_metrics_dict[test_size]["svm100_metrics_dict"]["acc"], combined_metrics_dict[test_size]["svm200_metrics_dict"]["acc"], combined_metrics_dict[test_size]["svm500_metrics_dict"]["acc"], combined_metrics_dict[test_size]["svm750_metrics_dict"]["acc"]]
...
def generate_plots(algo):
    ...
    for dataset in ["census", "phishing"]:
        ...
        make_beautiful_plots(dataset, combined_metrics_dict, algo)
